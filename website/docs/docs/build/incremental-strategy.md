...
`delete+insert` doesn't map directly to SCD logic (type 1 or 2) because it overwrites data at the row level and while it adds new rows, it does not track history.
